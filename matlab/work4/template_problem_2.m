...
tic
[z,lambda] = fmincon(); % hint: quadprog. Type 'doc quadprog' for more info 
t1=toc;
...
%% Do more
u1  = [z(N*mx+1:N*mx+M*mu);z(N*mx+M*mu)]; % Control input from solution
u2  = [z(N*mx+1:N*mx+M*mu);z(N*mx+M*mu)]; % Control input from solution
