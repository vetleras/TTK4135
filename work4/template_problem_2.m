...
Q = eye(mx); R = diag([1, 1]); %test 1
Q = diag([1, 100, 1, 1, 100, 1]); R = diag([1, 1]); %test 2
Q = diag([1, 100, 1, 1, 1000, 1]); R = diag([1, 1]); %test 3
Q = diag([1, 100, 1, 1, 1000, 1]); R = diag([10, 10]); %test 4
